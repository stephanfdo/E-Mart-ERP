...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "SELECT `item`.`item_name`, `item_category`.`category`, `item_subcategory`.`sub_category`, `item`.`quantity`
    FROM `item` 
...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="itemReport.php"><i class="fas fa-table"></i><span>Item Report</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
    ...
    ?>
                    <h3 class="text-dark mb-4">Item Report</h3>
                    <div class="row mb-3">
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">View item report</p>
                                        </div>
                                        <div class="card-body">
                                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        
                                                
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit">View Report</button></div>
                                            </form>
                                        </div>
                                    </div>
    ...
    if (isset($result) && $result->num_rows > 0) {
        ...
        echo "<tr><th scope='col'>Item Name</th><th scope='col'>Category</th><th scope='col'>Sub Category</th><th scope='col'>Quantity</th></tr>";
