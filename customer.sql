...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2023 at 06:56 PM
...
(5, 'Mr', 'Stephan', 'Gomez', 'Fernando', '0711270251', 7),
(6, 'Mr', 'Stephan', 'Gomez', 'Fernando', '0711270251', 16),
(7, 'Mr', 'Stephan', 'Gomez', 'Fernando', '0711270251', 18);
...
(7, '2021-04-07', '16:11:48', '1007', 2, '32', '24016'),
(8, '2021-04-09', '12:11:55', '1008', 2, '2', '150000');
...
(7, 'JK48967', 3, 1, 'Bulb', '10', '780'),
(8, 'JK48968', 2, 1, 'Bulb', '10', '780'),
(9, 'JK48967', 2, 1, 'Bulb', '10', '780');
...
--
ALTER TABLE `invoice_master`
  ADD CONSTRAINT `invoice_master_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `invoice_master_ibfk_2` FOREIGN KEY (`invoice_no`) REFERENCES `invoice` (`invoice_no`);
